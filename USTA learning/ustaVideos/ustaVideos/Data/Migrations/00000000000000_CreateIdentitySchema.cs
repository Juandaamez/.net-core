...
namespace ustaVideos.Data.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailConfirmed = table.Column<bool>(type: "varchar(256)", nullable: false),
                    ...
                    PhoneNumberConfirmed = table.Column<bool>(type: "varchar(256)", nullable: false),
                    TwoFactorEnabled = table.Column<bool>(type: "varchar(256)", nullable: false),
                    LockoutEnd = table.Column<DateTimeOffset>(type: "varchar(256)", nullable: true),
                    LockoutEnabled = table.Column<bool>(type: "varchar(256)", nullable: false),
                    AccessFailedCount = table.Column<int>(type: "varchar(256)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "varchar(256)", nullable: false)
